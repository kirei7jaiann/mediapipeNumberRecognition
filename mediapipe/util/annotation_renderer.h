...
class AnnotationRenderer {
 public:
  ...
  //add
  void DrawTextStr(std::string text, int left, int top, int font_size, int thickness, cv::Scalar color);
  void DrawCircle(int pointx, int pointy, int radius, int thickness, cv::Scalar color);
